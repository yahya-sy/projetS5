 ...
 */
final class Version20211029073905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD article_id INT DEFAULT NULL, ADD name VARCHAR(255) NOT NULL, DROP ref');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD ref LONGBLOB NOT NULL, DROP article_id, DROP name');
    }
}
