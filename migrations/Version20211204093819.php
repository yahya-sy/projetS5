 ...
 */
final class Version20211204093819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD article_id INT DEFAULT NULL, ADD name VARCHAR(255) NOT NULL, DROP fichierimg');
